<?php
// $productions = [
//     new Movies('The Matrix', 'English', 9, new Genre('Action', 'Neo giovane programmatore geniale scopre che il suo mondo altro non è ch una complessa illusione informatica creata da un programma chiamato Matrix'), 500, 120),
