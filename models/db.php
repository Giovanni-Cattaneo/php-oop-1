...
$cast_away = new Production('Cast Away', 'English', 8, new Genre('Drama', 'lorem ipsum dolor lorem ipsum dolor'));

$schindler_list = new Production('Schindler List', 'English', 9, new Genre('History', 'lorem ipsum dolor lorem ipsum dolor'));

$lord_of_the_rings = new Production('Lord Of The Rings', 'English', 10, new Genre('Fantasy', 'lorem ipsum dolor lorem ipsum dolor'));
